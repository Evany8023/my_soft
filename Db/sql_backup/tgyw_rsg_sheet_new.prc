create or replace procedure smzj.tgyw_rsg_sheet_new(
...
-- *************************************************************************
  ...
  v_job_name varchar2(100) :='tgyw_rsg_sheet_new';
 ...
 v_buy_count number; --购买次数
  ...
  cursor data_cur  is select t.investor_name,t.credit_no,t.credit_type_code,t.legal_person,t.handel_person,t.amount,t.investor_type,t.id
...
begin
 ...
 open data_cur_check ;
    ...
    open data_cur ;
    loop
        fetch data_cur into v_investor_name,v_credit_no,v_credit_type_code,v_legal_person,v_handel_person,v_rgje,v_investor_type,v_tab_id;
