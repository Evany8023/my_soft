create or replace view smzj.vm_quarterly_report as
select t.product_no,t.goal,t.strategy,t.standard,t.feature,t.brief,t.report_period,t.product_name,t.create_date,t.update_date,
  c.cp_name as comname,c.insti_code as comcode,
  ...
  dbms_lob.substr(t.introduction,2000 ,12001 ) as introduction7
    ...
    from  busi_quarterly_report t inner join busi_company c on c.id=t.cp_id where t.is_delete='0';
